...
(def-doom-theme anders-vellum
  ...
  (fw-base7           '("#f3f1eb" "#ffffff" "brightblack"))
  ...
  (vl-bg '("#f3f1eb" nil nil))
  (vl-bg-l1 (doom-lighten vl-bg 0.4))
  (vl-bg-l2 (doom-lighten vl-bg 0.6))
  (vl-bg-l3 (doom-lighten vl-bg 0.8))

  (vl-fg '("#2e3440" nil nil))
  (vl-fg-darkest '("#111111" nil nil))

  (vl-green '("#5c7b41" nil nil))

  (vl-blue '("#446b91" nil nil))

  (vl-orange '("#e8b245" nil nil))

  (vl-red '("#bf4753" nil nil))
  (vl-red-l1 (doom-lighten vl-red 0.4))
  (vl-red-l2 (doom-lighten vl-red 0.6))
  (vl-red-l3 (doom-lighten vl-red 0.8))
  ...
  ((centaur-tabs-unselected :background bg-alt :foreground base4)
    ...
    (default :background vl-bg :foreground vl-fg)

    (font-lock-builtin-face              :foreground vl-fg-darkest
                                         :inherit 'italic :extend t)

    (font-lock-comment-face              :foreground vl-green)
    ...
    (font-lock-function-name-face        :foreground vl-fg
                                         :underline vl-fg)

    (font-lock-keyword-face              :background vl-bg
                                         :foreground vl-fg-darkest)

    (font-lock-string-face               :background vl-bg
                                         :foreground vl-blue )


    ;; Rust
    (rustic-unsafe 
      :background vl-red-l2
      :foreground vl-fg)
